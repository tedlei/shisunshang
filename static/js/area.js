;(function () {
  ...
  $.fn.getArea = function (options) {
    var defaults = {
      ...
      scrollCity: 0,
      scrollRegion: 0,
      provinceObj: {'name': '', 'code': '', 'index': ''},
      cityObj: {'name': '', 'code': '', 'index': ''},
      regionObj: {'name': '', 'code': '', 'index': ''},
      normalArea: true,
      defaultArea: [21, 0, 0],
      inpVal: ''
    };
    ...
    $(this).each(function () {
      ...
      $(params.elePage).on(params.eventClick, params.confirmArea, function () {
        ...
        paramsobj.province_id = params.provinceObj.index
        paramsobj.city_id = params.cityObj.index
        paramsobj.area_id = params.regionObj.index
      ...
      function getAreaContent() {
        var html = '<div class="area-larger-mask" id="areaScrollMask">' +
          ...
          // '<div class="title-area-control"></div>' +
          '<div class="confirm-area-control">保存</div>' +
          '</div>' +
          '<div class="area-main">' +
        ...
        if ($('body .area-larger-main').length == 0) $('body').append(html);
      }
