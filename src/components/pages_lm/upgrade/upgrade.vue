  ...
  <div class="content upg_app">
    <div class="upg_img" v-if="userInfo">
      <van-image
        class="upg_bj"
        fit="contain"
        :src="require('../../../assets/img/zxsjbg.jpg')"
      />
      <div class="upg_com">
        <div class="img_b">
        ...
        <p
          style="font-size:0.13rem;color:#fff;margin-top:0.14rem"
        >会员当前等级：{{userInfo.level_name}}</p>
            ...
            getPageInfo() {
                ...
                this.$post("/api/v1/userLevel", ad_data)
                    .then(res => {
                        ...
                        this.topUpList = list;
                        //值留2位小数 多余去掉
                        let x_user_money = user_money.split(".")[1].length > 2 ? user_money.split(".")[1].substring(0, 2) : user_money.split(".")[1]
