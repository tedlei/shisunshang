<template>
  <div>
    <header ref="header_h">
      ...
      <span v-show="isCart  " style="position: absolute;right: 0.1rem;font-size: 0.16rem;color: #000;"
            @click="isDellBatch = !isDellBatch">编辑</span>
        ...
        <div v-for="(item, index1) in goodsObj" :key="index1">
          ...
          <div class="store_list">
            <div style="padding: 0.13rem 0;" class="store_top">
              <div style="margin-left: 0.1rem;" :class="item.checked ?'addRadioTwo':'addRadio'"
                   @click="chooseShopGoods(index1)">
            ...
            <div class="div1" v-for="(data, index) in item.list" :key="index">
              <!-- 商品卡片 -->
              <div class="goods_bot">
                <div style="margin-left:0.1rem;" :class="data.checked ?'addRadioTwo':'addRadio'"
