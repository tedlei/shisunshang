        ...
        <div class="right_ul">
          ...
          >
            <div class="right_li" v-for="(item,index) in cpylist" :key="index">
              <div
                class="right_route"
                @click="tapRoute({path:'/business/storemsg',query:{id: item.id}})"
              >
                <div class="imgDiv">
                ...
                <div class="right_por">
                  <div class="right_msg">
                    ...
                    <div style="margin: 0.02rem 0;" class="address">地址：{{item.address}}</div>
                    <div class="address">
                      <span>电话：</span>
...
export default {
  ...
  data() {
    return {
      msg: "附近商家",
      height: "1rem",
      num: sessionStorage.getItem("businessNum")
        ? sessionStorage.getItem("businessNum")
        : 0,
      isUlliTwo: true,
      isUlliTwoHeight: 1,
      leftlists: [], //一级导航列表
