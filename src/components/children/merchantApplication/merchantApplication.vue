<template>
  <div class="content">
    ...
    <div class="inputs">
      ...
      <div class="address">
        <div>
          ...
          <div
            :class="currentTimeMsg=='开始时间'?'startDatetime':'startDatetime startDatetimeColor'"
            @click="showDatetime=true"
          >
            <span>{{currentTimeMsg}}</span>
          </div>&nbsp;一&nbsp;至&nbsp;一&nbsp;&nbsp;
          <div
            :class="currentTimeMsgTwo=='结束时间'?'startDatetime':'startDatetime startDatetimeColor'"
      ...
      <div
        :class="btnBk?'btn btnTwo':'btn'"
        @click="upData"
      >{{$route.query.state=='edit'?'保存':'提交申请'}}</div>
    ...
    <van-popup v-model="showDatetimeTwo" position="bottom">
      <van-datetime-picker
  ...
  methods: {
    ...
    upData: Throttle(function() {
      ...
      if (this.input == "") {
        ...
        this.currentTimeMsg == "开始时间" &&
        this.currentTimeMsgTwo == "结束时间"
      ) {
